    ...
    public static void main(String[] args)
       {
        ...
        bstTest = uploadData( "E:\\_JAVA\\CS249homework\\src\\p7_package\\inData.txt" );
        ...
        bstTest.removeNode( new StudentClassNode( "", 119410, 'X', 0.00 ) );
        System.out.println( "\nAfter remove,Inorder display:\n" + bstTest.outputInOrder() );
        
        System.out.println( bstTest.search(new StudentClassNode("", 819367, 'x', 0.00)).toString() );
        
        
        //search a value which isn't included in the tree
        //wrong,不该在方法中调用方法，并且应该另当考虑
//        System.out.println( bstTest.search(new StudentClassNode("", 982316, 'x', 0.00)).toString() );
        
//        StudentClassNode testStr = bstTest.search(new StudentClassNode("", 982316, 'x', 0.00));
//        if( testStr == null )
//           {
//            System.out.println("sorry，the value is not in the binary tree");
//           }
//        else
//           {
