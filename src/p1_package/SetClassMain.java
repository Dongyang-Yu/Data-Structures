    ...
    public static void main(String[] args)
       {
        ...
        SetClass sc_relComplement = new SetClass();
         ...
         System.out.println( "Intersection Sets 1/2: " + sc_Intersection.toString()  );       

         System.out.println( "Relative complement Sets 1/2: " + sc_relComplement.toString() );
       
         sc_3.findPowerSet();
         System.out.println( "Power Set of Set 3: " + sc_3.powerSetToString() );
       }
